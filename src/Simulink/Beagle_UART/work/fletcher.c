 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Nov 19 14:47:58 2014
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME fletcher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void fletcher_Outputs_wrapper(const int16_T *u0,
			const real_T *count,
			int16_T *y0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *count  = (const real_T*) ssGetInputPortSignal(S,1);
    int16_T        *y0  = (int16_T *)ssGetOutputPortRealSignal(S,0);


    fletcher_Outputs_wrapper(u0, count, y0);
